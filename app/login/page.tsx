  ...
  return (
    <main className="login-page">
      <div className="login-shell">
        ...
        <Link className="home-link" href="/">← Back to Mutual Assent AI</Link>
      <style>{`
        .login-page { min-height: 100vh; position: relative; padding: 58px 0 80px; background: #f5f7fa; }
        .login-shell { width: min(430px, calc(100% - 28px)); margin: 0 auto; }
        .login-shell .legal { max-width: 380px; margin: 18px auto 0; color: #717b8d; font-size: 13px; line-height: 1.5; text-align: center; }
        .home-link { position: absolute; top: 28px; left: 50%; transform: translateX(-50%); color: #5f6a7e; font-size: 14px; font-weight: 650; text-decoration: none; }
      `}</style>
    </main>
  );
}
