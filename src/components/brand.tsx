...
export function Brand({ compact = false }: { compact?: boolean }) {
  return (
    <Link href="/" className="brand" aria-label="Mutual Assent AI home">
      <Image className="brand-mark" src="/mutual-assent-mark-cobalt.png" width={152} height={152} alt="" priority />
      ...
      <style jsx>{`
        :global(.brand-mark) { width: 152px; height: 152px; margin-left: -37px; margin-right: -25px; object-fit: contain; }
